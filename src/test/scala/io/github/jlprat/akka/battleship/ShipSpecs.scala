...
class ShipSpecs extends FlatSpec with Matchers {
    ...
    "A ship" should "be placed first before receiving shoots" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Unexpected message!"))
    }
    ...
    it should "be placed" in {
        ...
        testKit.returnedBehavior should not be Behavior.same

        handler.expectMessage(Ship.Placed)

        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Placed Ship (1,3) - (1,5)"))
    }
    ...
    it should "be refuse to be placed is place is too big" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Ship of size 3 can't be placed in (1,3) - (1,6)"))
    }
    ...
    it should "be refuse to be placed is place is too small" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Ship of size 3 can't be placed in (1,3) - (1,4)"))
    }
    ...
    it should "reply with hit when shoot is in any of the ship's coordinates" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Ship shot at (1,3)"))
    }
    ...
    it should "reply with sunk when shoot is the last of the ship's alive coordinates" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Ship shot and sunk at (1,3)"))
    }
    ...
    it should "reply with miss when shoot is not any of the ship's coordinates" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Miss!"))
    }
    ...
    it should "reply with hit when shoot is already hit in that cooridinate" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Ship already shot at (1,4)"))
    }
    ...
    it should "reply with sunk when shoot is any of ship's coordinates and already sunk" in {
        ...
        testKit.logEntries() shouldBe Seq(CapturedLogEvent(Logging.InfoLevel, "Ship already sunk at (1,3)"))
    }
